...
namespace PruebaDetail.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Cedula,Nombre,Apellido1,Apellido2,Usuario,Password,Correo,Puntos")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Cedula,Nombre,Apellido1,Apellido2,Usuario,Password,Correo,Puntos")] Cliente cliente)
        {
